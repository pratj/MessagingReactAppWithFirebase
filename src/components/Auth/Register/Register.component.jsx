...
const Register =()=>{
    ...
    <img src="https://static.wixstatic.com/media/c1c203_6eea7ea049cf43f0b2dfaccc6894bb81~mv2.gif" alt=""/>
        
        <Form onSubmit={onSubmit    }>
            <Segment stacked>
            <Header float="center" >
            <span icon as="h3">Register</span>
            ...
            <Button color="green" disabled={isLoading} loading={isLoading}>Submit</Button> 
        </Form>
